...
@HiltViewModel
class CreateAccountFarmerViewModel @Inject constructor(
    ...
    fun saveUserData() {
        registrationDataRepository.apply {
            ...
            firstName = this@CreateAccountFarmerViewModel.firstName.value
            lastName = this@CreateAccountFarmerViewModel.lastName.value
            city = this@CreateAccountFarmerViewModel.city.value
            country = this@CreateAccountFarmerViewModel.country.value
            birthDate = this@CreateAccountFarmerViewModel.birthDate.value
        }
    }
